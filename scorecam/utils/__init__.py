...
def visualize(input_, gradients, save_path=None, cmap='viridis', alpha=0.5):
...
def basic_visualize(input_, gradients, save_path=None, weight=None, cmap='viridis', alpha=0.5):
    """ Method to plot the explanation.
...
def gradient_visualize(gradients, save_path=None, weight=None, cmap='viridis', alpha=1.0):
    """ Method to plot the explanation.
...
def overlay_visualize(input_, gradients, save_path=None, weight=None, cmap='viridis', alpha=0.5):
    """ Method to plot the explanation.
    ...
    plt.figure()  # 不指定 figsize，會依照圖片大小自動調整
    plt.imshow(input_)
    plt.imshow(gradients, cmap=cmap, alpha=alpha)
    plt.axis('off')
    plt.tight_layout()
